/*! JSON Editor v1.4.0 - JSON Schema -> HTML Editor
...
if(!b)return this.watchlist[a]=null,this;for(var c=[],d=0;d<this.watchlist[a].length;d++)this.watchlist[a][d]!==b&&c.push(this.watchlist[a][d]);return this.watchlist[a]=c.length?c:null,this},notifyWatchers:function(a){if(!this.watchlist||!this.watchlist[a])return this;for(var b=0;b<this.watchlist[a].length;b++)this.watchlist[a][b]()},isEnabled:function(){return!this.root||this.root.isEnabled()},enable:function(){this.root.enable()},disable:function(){this.root.disable()},_getDefinitions:function(a,b){if(b=b||"#/definitions/",a.definitions)for(var c in a.definitions)a.definitions.hasOwnProperty(c)&&(this.refs[b+c]=a.definitions[c],a.definitions[c].definitions&&this._getDefinitions(a.definitions[c],b+c+"/definitions/"))},_getExternalRefs:function(a){var b={},c=function(a){for(var c in a)a.hasOwnProperty(c)&&(b[c]=!0)};a.$ref&&"object"!=typeof a.$ref&&"#"!==a.$ref.substr(0,1)&&!this.refs[a.$ref]&&(b[a.$ref]=!0);for(var d in a)if(a.hasOwnProperty(d))if(a[d]&&"object"==typeof a[d]&&Array.isArray(a[d]))for(var e=0;e<a[d].length;e++)a[d][e]&&"object"==typeof a[d][e]&&c(this._getExternalRefs(a[d][e]));else a[d]&&"object"==typeof a[d]&&c(this._getExternalRefs(a[d]));return b},_loadExternalRefs:function(a,b){var c=this,e=this._getExternalRefs(a),f=0,g=0,h=!1;d(e,function(a){if(!c.refs[a]){if(!c.options.ajax)throw"Must set ajax option to true to load external ref "+a;c.refs[a]="loading",g++;var d=a;c.options.ajaxBase&&c.options.ajaxBase!=a.substr(0,c.options.ajaxBase.length)&&"http"!=a.substr(0,4)&&(d=c.options.ajaxBase+a);var e=new XMLHttpRequest;e.open("GET",d,!0),c.options.ajaxCredentials&&(e.withCredentials=c.options.ajaxCredentials),e.onreadystatechange=function(){if(4==e.readyState){
// Request succeeded
if(200!==e.status)throw window.console.log(e),"Failed to fetch ref via ajax- "+a;var i;try{i=JSON.parse(e.responseText)}catch(j){throw window.console.log(j),"Failed to parse external ref "+d}if(!i||"object"!=typeof i)throw"External ref does not contain a valid schema - "+d;c.refs[a]=i,c._loadExternalRefs(i,function(){f++,f>=g&&!h&&(h=!0,b())})}},e.send()}}),g||b()},expandRefs:function(a){for(a=c({},a);a.$ref;){var b=a.$ref;delete a.$ref,this.refs[b]||(b=decodeURIComponent(b)),a=this.extendSchemas(a,this.refs[b])}return a},expandSchema:function(a){var b,e=this,f=c({},a);
...
f[a]=c.concat(b[a]).reduce(function(a,b){return a.indexOf(b)<0&&a.push(b),a},[]):f[a]=c}),d(b,function(b,c){"undefined"==typeof a[b]&&(f[b]=c)}),f},setCopyClipboardContents:function(a){this.copyClipboard=a},getCopyClipboardContents:function(){return this.copyClipboard}},f.defaults={themes:{},templates:{},iconlibs:{},editors:{},languages:{},resolvers:[],custom_validators:[]},f.Validator=a.extend({init:function(a,b,c){this.jsoneditor=a,this.schema=b||this.jsoneditor.schema,this.options=c||{},this.translate=this.jsoneditor.translate||f.defaults.translate},fitTest:function(a){var b=0,d=0;if("object"==typeof a&&null!==a){
// Work on a copy of the schema
var e=c({},this.jsoneditor.expandRefs(this.schema));for(var f in e.properties)e.properties.hasOwnProperty(f)?"undefined"!=typeof a[f]&&b++:d++}return{match:b,extra:d}},validate:function(a){return this._validateSchema(this.schema,a)},_validateSchema:function(a,b,e){var g,h,i,j=this,k=[],l=JSON.stringify(b);/*
...
// `properties`
var q={};if(a.properties)if("undefined"!=typeof a.required&&Array.isArray(a.required))for(h=0;h<a.required.length;h++){var r=a.required[h];q[r]=!0,k=k.concat(this._validateSchema(a.properties[r],b[r],e+"."+r))}else for(h in a.properties)a.properties.hasOwnProperty(h)&&(q[h]=!0,k=k.concat(this._validateSchema(a.properties[h],b[h],e+"."+h)));
// `patternProperties`
if(a.patternProperties)for(h in a.patternProperties)if(a.patternProperties.hasOwnProperty(h)){var s=new RegExp(h);
// Check which properties match
for(i in b)b.hasOwnProperty(i)&&s.test(i)&&(q[i]=!0,k=k.concat(this._validateSchema(a.patternProperties[h],b[i],e+"."+i)))}
...
var c=this,e=this.type,f={match:0,extra:0,i:0};d(this.validators,function(b,d){if(!d.validate(a).length){if("undefined"==typeof c.anyOf||!c.anyOf)return c.type=b,c.switcher.value=c.display_text[b],!1;var e=d.fitTest(a);f.match<e.match?(f=e,f.i=b):f.match===e.match&&f.extra>e.extra&&(f=e,f.i=b)}}),"undefined"!=typeof c.anyOf&&c.anyOf&&(c.type=f.i,c.switcher.value=c.display_text[f.i]);var g=this.type!=e;g&&this.switchEditor(this.type),this.editors[this.type].setValue(a,b),this.refreshValue(),c.onChange(g)},destroy:function(){d(this.editors,function(a,b){b&&b.destroy()}),this.editor_holder&&this.editor_holder.parentNode&&this.editor_holder.parentNode.removeChild(this.editor_holder),this.switcher&&this.switcher.parentNode&&this.switcher.parentNode.removeChild(this.switcher),this._super()},showValidationErrors:function(a){var b=this;
